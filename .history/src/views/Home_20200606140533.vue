<template>
 <div>
  ...
  <div >
    ...
    <div v-for="(item,index) in arr" :key="index" class="text item">
    <a href="" class="img"><img :src="item.author.avatar_url" alt="" width="20px" height="20px"></a>{{item.reply_count}}/{{item.visit_count}} {{item.title}}
    </div>
      <!-- 分页器 -->
    <div class="block">
    <el-pagination
